% adf(SECTION) | User Commands
%
% "Thu, 23 Jul 2026 11:35:19 +0200"
...
adf - program to do something

# SYNOPSIS

**adf** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**adf** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **adf** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**adf** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    adf. See **foo.conf**(5) for further details.
...
**adf** provides some return codes, that can be used in scripts:
...
Copyright © 2026 Raul Rodrigo Segura
